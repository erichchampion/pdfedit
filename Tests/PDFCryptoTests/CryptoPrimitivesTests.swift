...
@Test func md5Vectors() async throws {
    #expect(CryptoPrimitives.md5(Array("".utf8)) == hex("d41d8cd98f00b204e9800998ecf8427e"))
    #expect(CryptoPrimitives.md5(Array("abc".utf8)) == hex("900150983cd24fb0d6963f7d28e17f72"))
}

@Test func sha2Vectors() async throws {
    let abc = Array("abc".utf8)
    #expect(CryptoPrimitives.sha256(abc) == hex("ba7816bf8f01cfea414140de5dae2223b00361a396177a9cb410ff61f20015ad"))
    #expect(CryptoPrimitives.sha384(abc) == hex("cb00753f45a35e8bb5a03d699ac65007272c32ab0eded1631a8b605a43ff5bed8086072ba1e7cc2358baeca134c825a7"))
    #expect(CryptoPrimitives.sha512(abc) == hex("ddaf35a193617abacc417349ae20413112e6fa4e89a97ea20a9eeee64b55d39a2192992a274fc1a836ba3c23a3feebbd454d4423643ce80e2a9ac94fa54ca49f"))
}
